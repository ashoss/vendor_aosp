...
custom_local_manifest = ".repo/local_manifests/tpp.xml"
...
org_manifest = "tpp-devices"  # leave empty if org is provided in manifest
org_display = "tpp-devices"  # needed for displaying
